...
head:
  - - meta
    - property: og:title
      content: "5 Things I Wish I Knew Before My First Real Run | Scroll Tome"
  - - meta
    - property: og:description
      content: "A player's honest breakdown of HoMM: Olden Era's deeper mechanics — from the dual-hero early game system to PvP timing traps and Nature faction unit upgrades."
  - - link
    - rel: canonical
      href: https://scrolltome.com/guide/06-hardcore-early-game-guide
---
